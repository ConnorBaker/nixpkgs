...
let
  ...
  # the directories this file puts on a command line have to come out of the same one. Reaching for
  ...
  imagesOf = project: "${src}/nvJPEG2000/${project}/images";
